...
/**
 * Created by JinHeng on 1/4/2015.
 */
public class PlaceProvider extends ContentProvider {

    public static final String AUTHORITY = "com.project.jinheng.fyp.classes.PlaceProvider";
    ...
    String mKey = "AIzaSyByNl5n2fXo3Q-_pYbI_gnJU1EjzBW3jxc";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        GooglePlacesJSONParser parser = new GooglePlacesJSONParser();
        GooglePlacesDetailsJSONParser detailsParser = new GooglePlacesDetailsJSONParser();
        ...
        switch (mUriMatcher.match(uri)) {
            case SEARCH:
                ...
                parser = new GooglePlacesJSONParser();

                // Create a parser object to parse place details in JSON format
                detailsParser = new GooglePlacesDetailsJSONParser();
